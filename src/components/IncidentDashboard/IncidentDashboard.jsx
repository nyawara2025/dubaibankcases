          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full">
            <header className="w-full mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <div className="flex gap-3">
                <button 
                   onClick={exportCSV}
                   className="px-4 py-2 border border-slate-700 rounded-lg text-[10px] font-black uppercase hover:bg-slate-800 transition-colors"
                >
                  Export CSV
                </button>
                <button 
                   onClick={() => setIsModalOpen(true)}
                   className="px-6 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-[10px] font-black uppercase shadow-lg shadow-indigo-500/20 transition-all"
                >
                  + Log Incident
                </button>
              </div>
